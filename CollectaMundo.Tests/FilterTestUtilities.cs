...
namespace CollectaMundo.Tests
{
            ...
            return new List<CardSet>
    {
        new CardSet
        {
            Name = "Churning Eddy",SetName = "Torment",ManaCost = "3,U",Types = "Sorcery",
            Colors = "U",
            SuperTypes = "",SubTypes = "",Type = "Sorcery",Keywords = "",
            Text = "Return target creature and target land to their owners' hands.",ManaValue = 4,Language = "English",
            Finishes = "nonfoil, foil",Rarity = "common",NormalPrice = 0.02M,FoilPrice = 0.61M,EtchedPrice = null
        },
        new CardSet
        {
            ...
            ManaValue = 4,Language = "English",Finishes = "nonfoil, foil",Rarity = "mythic",NormalPrice = null,FoilPrice = null,EtchedPrice = null
        },
        new CardSet
        {
            ...
            ManaValue = 5,Language = "English",Finishes = "nonfoil, foil",Rarity = "rare",NormalPrice = null,FoilPrice = null,EtchedPrice = null
        },
        new CardSet
        {
            ...
            ManaValue = 5,Language = "English",Finishes = "nonfoil, foil",Rarity = "uncommon",NormalPrice = 0.04M,FoilPrice = 0.12M,EtchedPrice = null
        },
        new CardSet
        {
            ...
            ManaValue = 4,Language = "English",Finishes = "nonfoil, foil",Rarity = "mythic",NormalPrice = 6.13M,FoilPrice = 9.83M,EtchedPrice = null
        },
        new CardSet
        {
            ...
            ManaValue = 2,Language = "English",Finishes = "nonfoil",Rarity = "rare",NormalPrice = null,FoilPrice = null,EtchedPrice = null
        },
        new CardSet
        {
        ...
        new CardSet
        {
            ...
            ManaValue = 5,Language = "English",Finishes = "nonfoil",Rarity = "uncommon",NormalPrice = 0.07M,FoilPrice = null,EtchedPrice = null
        },
        new CardSet
        {
            ...
            ManaValue = 3,Language = "English",Finishes = "nonfoil",Rarity = "rare",NormalPrice = 0.22M,FoilPrice = 0.05M,EtchedPrice = null
        },
        new CardSet
        {
            ...
            ManaValue = 4,Language = "English",Finishes = "nonfoil, foil",Rarity = "mythic",NormalPrice = 0.63M,FoilPrice = 0.85M,EtchedPrice = null
        },
        new CardSet
        {
            ...
            ManaValue = 2,Language = "English",Finishes = "nonfoil, foil",Rarity = "rare",NormalPrice = 10.11M,FoilPrice = 11.78M,EtchedPrice = null
        },
        new CardSet
        {
            Name = "Propagator Drone",SetName = "Modern Horizons 3",ManaCost = "1,G",Types = "Creature",
            Colors = "",SuperTypes = "",
            SubTypes = "Eldrazi, Drone",Type = "Creature — Eldrazi Drone",Keywords = "Devoid",
            ...
            ManaValue = 2,Language = "English",Finishes = "nonfoil, foil",Rarity = "uncommon",CardsOwned=0,CardsForTrade=0
        },
        new CardSet
        {
            ...
            ManaValue = 4,Language = "English",Finishes = "nonfoil, foil",Rarity = "uncommon",CardsOwned=0,CardsForTrade=0
        },
        new CardSet
        {
            Name = "Tarfire",
        ...
        new CardSet
        {
            ...
            SubTypes = "Lukka",
            Type = "Legendary Planeswalker — Lukka",
            Keywords = "Compleated",
        ...
        new CardSet
        {
            Name = "Bounty: Eriana, Wrecking Ball // Wanted!",
