...
namespace CollectaMundo.Tests
{
    ...
    public sealed class SeedIntegrationTests(InMemoryDatabaseFixture fixture)
    ...
    public sealed class CardViewModelIntegrationTests(InMemoryDatabaseFixture fixture)
    : IClassFixture<InMemoryDatabaseFixture>, IAsyncLifetime
    {
        private readonly InMemoryDatabaseFixture _fx = fixture;
        private MainWindowViewModel _mainVM = null!;
    ...
    public sealed class FilterViewModelIntegrationTests(InMemoryDatabaseFixture fixture) : IClassFixture<InMemoryDatabaseFixture>, IAsyncLifetime
    {
        private readonly InMemoryDatabaseFixture _fx = fixture;
        private MainWindowViewModel _mainVM = null!;
        private readonly List<CardChangeEventArgs> _changedEvents = [];
