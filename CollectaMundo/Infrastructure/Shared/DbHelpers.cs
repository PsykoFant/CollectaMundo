...
namespace CollectaMundo.Infrastructure.Shared
{
    public static class DbHelpers
    {
        ...
        public static async Task<List<string>> GetUniqueValuesAsync(SQLiteConnection conn, string tableName, string columnName, SQLiteTransaction? tx = null, CancellationToken ct = default)
        {
            ...
            using var command = CreateCommand(conn, tx, query);
