...
namespace CollectaMundo.ViewModels.Pages
{
    ...
    public abstract class CardListPageViewModelBase(CardViewModel cardsVM, CardImageViewModel cardImageVM, FilterViewModel filterVM, ObservableCollection<ObservableCollection<double>> columnWidths, PricesViewModel? pricesVM = null, EditCollectionViewModel? addOrEditCardsVM = null)
    {
