...
namespace CollectaMundo.DomainLogic.CollectionMutations
{
    public class CollectionMutationsLogic : ICollectionMutationsLogic
    {
        ...
        // Applies the given change set to the collection in-place. 
        public void ApplyCollectionChangeSet(IList<CardSet> collection, CollectionChangeSet<CardSet> changes)
        {
