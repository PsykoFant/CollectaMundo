...
namespace CollectaMundo.ApplicationServices.DownloadResourceFiles
{
    ...
    {
        Task<OperationResult> DownloadAsync(string url, string targetPath, string label, int retryDelayInMs, IProgress<string>? detailProgress = null, IProgress<int>? percentProgress = null, CancellationToken token = default);
