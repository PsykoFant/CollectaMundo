...
{
    public class TestableFilterItemViewModel(string criteriaKey, IEnumerable<FilterOption> filterOptions, string defaultText, string readableLabel, FilterPanelViewModel filterViewModel, IFilterItemSearchLogic filterItemSearchLogic,
