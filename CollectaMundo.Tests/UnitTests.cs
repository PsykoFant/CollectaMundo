    ...
    public class UnitTests
    {
        ...
        public class EditCollectionLogicTests
        {
            ...
            public async Task SaveBatchAsync_AddNewCard_WhenNotExisting()
            {
                ...
                // Act
                var results = await logic.SaveBatchAsync([newCard], isEdit: false);
                ...
                repo.Verify(r => r.AddCardAndReturnIdAsync(newCard), Times.Once);
            }
            [Fact]
            public async Task SaveBatchAsync_ddNewCard_AddToExisting()
            {
                var repo = new Mock<IEditCollectionRepository>();

                // When we ask “find existing?”, return card id 123
                repo.Setup(r => r.FindExistingCardReturnIdAsync(It.IsAny<CardSet>())).ReturnsAsync((123));
                ...
                repo.Setup(r => r.GetTotalsAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync((6, 4));
                ...
                // verify repo was called
                repo.Verify(r => r.UpdateCardCountsAsync(newCard), Times.Once);
                repo.Verify(r => r.GetTotalsAsync(newCard.Uuid, newCard.SelectedCondition, newCard.Language, newCard.SelectedFinish), Times.Once);
            ...
            public async Task SaveBatchAsync_EditCard_DeleteByZero()
            {
                ...
                // Act
                var results = await logic.SaveBatchAsync([newCard], isEdit: true);
                ...
                // verify repo was called
                repo.Verify(r => r.DeleteCardByIdAsync(newCard), Times.Once);
            ...
            public async Task SaveBatchAsync_EditCard_Update_no_merge()
            {
                ...
                // Return a single id
                repo.Setup(r => r.FindRecordByIdAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync([123]);
                ...
                // verify repo was called
                repo.Verify(r => r.UpdateCardAsync(newCard), Times.Once);

                // verify this was NOT called
                repo.Verify(r => r.MergeDuplicateRecordsAsync(newCard.Uuid, newCard.SelectedCondition, newCard.Language, newCard.SelectedFinish, 123), Times.Never);
            }
            ...
            public async Task SaveBatchAsync_EditCard_Update_merge()
            {
                ...
                // Return multiple ids
                repo.Setup(r => r.FindRecordByIdAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync([123, 456, 789]);
                ...
                // verify this was NOT called
                repo.Verify(r => r.MergeDuplicateRecordsAsync(newCard.Uuid, newCard.SelectedCondition, newCard.Language, newCard.SelectedFinish, 123), Times.Once);
            }
        }
    }
}
